...
3. ShowBindingAction.cs - действие запуска окна «Привязка». Вызывается через пункт меню «Привязка».
4. ShowDevicesNewAction.cs - действие запуска окна «Устройства». Вызывается через пункт меню «Устройства».
