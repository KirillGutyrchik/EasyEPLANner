...
<p align="justify">Окно <b>«Устройства»</b> вызывается через пункт меню <b>EPlaner → Устройства</b>. Подробное описание — в <a href="DevicesView.md">документации по окну устройств</a>.</p>
